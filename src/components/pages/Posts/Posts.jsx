...
//         mb={3}
//       >
//         <Button variant="contained" component={Link} to={"../PostForm"}>
//           اضافة خبر جديد +
//         </Button>
//       </Stack>
//       <Stack
//         direction="row"
//         spacing={10} // Increased spacing between items
//         sx={{
//           overflowX: "auto",
//           "&::-webkit-scrollbar": { display: "none" },
//           scrollbarWidth: "none",
//           py: 4, // Add vertical padding to the container for better spacing
//         }}
//       >
//         {posts.map((post) => (
//           <PostCard
...
//             sx={{ maxWidth: 300 }} // Optional: set a minimum width for each card
//           />
//         ))}
//       </Stack>
//     </Container>
...
//       >
//         {posts.map((post) => (
//           <Box key={post.id} sx={{ minWidth: 300, margin: 2 }}>
