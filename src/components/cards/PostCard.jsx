...
//       <CardHeader
//         avatar={<Avatar src={activePost.user.profilePicture} />}
//         title={`${activePost.user.firstName} ${activePost.user.lastName}`}
//         subheader={formatDistanceToNow(activePost.createdAt, {
//           addSuffix: true,
//           locale: ar,
//         })}
//         sx={{ padding: 2 }}
...
import DeleteIcon from "@mui/icons-material/Delete";
import { useNavigate } from "react-router-dom";
import "./PostCard.css"; // Make sure to import the CSS file
