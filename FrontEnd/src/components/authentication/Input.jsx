...
//   touched,
// }) {
//   //Props:destructing==> const{name,type}=props
...
//           onBlur={onBlur}
//         />
//         <label htmlFor={id} className={`${style.lable}`}>
//           {title}
//         </label>
//         {touched[name] && errors[name] && (
//           <p className={`${style.text} alert `}>{errors[name]}</p>
//         )}
//       </div>
//     </>
//   );
      ...
      {type === "select" ? (
        <>
          ...
          <select
            ...
            className="form-control"
          >
            <option value="" disabled htmlFor={id} className={`${style.label}`}>
              اختر {title}
            </option>
